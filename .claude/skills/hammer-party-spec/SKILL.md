...
Match length **15–20 min (hard cap ~20)**. Style **3D low-poly, cartoon**.

> **Ratios matter more than exact numbers.** HP/damage get co-tuned in Phase 02
> playtests. Read every value from `packages/shared/src/constants.ts` — never hardcode.
